...
Primer release público: pipeline CLI (`tag`, `enrich`, `organize`,
`recalibrate`, `pipeline`) con paridad verificada contra los scripts
originales. Desviaciones deliberadas respecto a los originales:
